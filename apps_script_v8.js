// COPIHUE HERRAMIENTAS + CANALES TV - Apps Script Web App v8
// v8: soporte columna CHANGELOG en updateRow, getHerramientas y agregarFila
...
function doGet(e) {
  ...
  return ContentService
    .createTextOutput(JSON.stringify({ status: 'ok', msg: 'API v8 activa' }))
