// COPIHUE HERRAMIENTAS + CANALES TV - Apps Script Web App v6
// v6: soporte campo 'ver' en updateRow para bump de versión desde el panel
...
function doGet(e) {
  ...
  return ContentService
    .createTextOutput(JSON.stringify({ status: 'ok', msg: 'API v6 activa' }))
